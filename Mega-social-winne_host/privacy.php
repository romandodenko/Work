  ...
  <main>
    <section class="polts">
      <div class="polts__container container">
        <h1>Privacy Policy for Mega social winne</h1>

        <p>At Mega social winne, accessible from Mega social winne, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information that is collected and recorded by Mega
          social winne and how we use it.</p>
        ...
        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
          regards to the information that they shared and/or collect in Mega social winne. This policy is not applicable
        ...
        <p>Mega social winne follows a standard procedure of using log files. These files log visitors when they visit
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Mega social
          winne.</p>

        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
          used in their respective advertisements and links that appear on Mega social winne, which are sent directly to
        ...
        <p>Note that Mega social winne has no access to or control over these cookies that are used by third-party
          advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>Mega social winne's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
