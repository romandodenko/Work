...
?>
  ...
  <main>
    <section class="polts">
      <div class="polts__container container">
        <h1><strong>Terms and Conditions</strong></h1>

        <p>Welcome to Mega social winne!</p>

        <p>These terms and conditions outline the rules and regulations for the use of Mega social winne's Website,
          located at Mega social winne.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Mega social
          winne if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p>We employ the use of cookies. By accessing Mega social winne, you agreed to use cookies in agreement with the
          Mega social winne's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, Mega social winne and/or its licensors own the intellectual property rights for all
          material on Mega social winne. All intellectual property rights are reserved. You may access this from Mega
          social winne for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Mega social winne</li>
          <li>Sell, rent or sub-license material from Mega social winne</li>
          <li>Reproduce, duplicate or copy material from Mega social winne</li>
          <li>Redistribute content from Mega social winne</li>
        </ul>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. Mega social winne does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of Mega social winne,its agents and/or
          affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
          extent permitted by applicable laws, Mega social winne shall not be liable for the Comments or for any
        ...
        <p>Mega social winne reserves the right to monitor all Comments and to remove any Comments which can be
        ...
        <p>You hereby grant Mega social winne a non-exclusive license to use, reproduce, edit and authorize others to
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Mega
          social winne; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you must inform us by sending an e-mail to Mega social winne. Please include your name, your organization
        ...
        <p>No use of Mega social winne's logo or other artwork will be allowed for linking absent a trademark license
          agreement.</p>
  ...
  <div class="popup popup-active">
    ...
    <div class="popup__body">
      <p class="popup__text">
        We use cookies for a better user experience, for analytical and marketing purposes. We do this to understand how
        you use our websites, mobile applications and services, to improve their performance and develop them according
        to the tastes of our customers and visitors.
      </p>
      <div class="popup__wrapper-btn">
