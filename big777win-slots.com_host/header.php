...
<head>
  ...
  <title>big777win-slots.com</title>
</head>

<body>
  <div class="page">
    <header class="topping">
      <div class="topping__container container">
        ...
        <a class="topping__logo" href="main.php">
          <img src="./img/logo.svg" alt="Image">
        </a>
        <div class="topping__menu">
          <nav class="nav">
            <ul class="nav__list">
              <li class="nav__item">
              ...
              <li class="nav__item nav__item_logo">
                <a class="nav__logo nav__logo_menu" href="main.php" data-da=".topping__menu, 991, first">
                  <img src="./img/logo.svg" alt="Image">
                </a>
              </li>
              <li class="nav__item">
          ...
          <button class="topping__exit-menu"></button>
        </div>
      </div>
    </header>