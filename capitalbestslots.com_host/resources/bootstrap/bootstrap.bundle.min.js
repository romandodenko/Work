! function (t, e) {
  ...
  class Hi extends B {
    ...
    _initializeBackDrop() {
      return new bi({
        isVisible: Boolean(this._config.bgdrop),
    ...
    _showBackdrop(t) {
      j.on(this._element, Si, (t => {
        this._ignoreBackdropClick ? this._ignoreBackdropClick = !1 : t.target === t.currentTarget && (!0 === this._config.bgdrop ? this.hide() : "static" === this._config.bgdrop && this._triggerBackdropTransition())
