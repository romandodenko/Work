...
<head>
  ...
  <link rel="stylesheet" href="./css/entrance-min.css">
  <?php 
    require "db.php";
  ?>
...
<body>
  ...
  <header class="page-header">
    ...
    <main>
      <section class="page-entrance">
        <div class="page-entrance__container container">
          <div class="page-entrance__body">
            <form class="page-entrance__form" action="#" method="POST">
              <div class="page-entrance__label">
                <input class="page-entrance__input" type="text" placeholder="Your login" name="login">
              </div>
              <div class="page-entrance__label">
                <input class="page-entrance__input" type="password" placeholder="Password" name="password">
              </div>
              <input class="page-entrance__btn" type="submit" name="log_in" value="Συνδεθείτε">
            </form>
            <?php
            $data = $_POST;
            if(isset($data['log_in'])) {
              ...
              $errors = 'Δεν βρέθηκε χρήστης με αυτό το όνομα!';
            }
            if(!empty($errors)) {
