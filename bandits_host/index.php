 ...
 <main>
   <section class="hero">
    <div class="hero__container container">
      <div class="row d-flex flex-column justify-content-center">
        <div class="hero__body d-flex flex-column col-12 col-md-7 col-lg-6">
          <h1 class="hero__title">
            Darmowe społecznościowe gry kasynowe
          </h1>
          <div class="hero__wrapper-link">
            <a class="hero__link" data-scroll href="#game">Zagraj teraz</a>
          </div>
      </div>
      </div>
    </div>
    ...
    <div class="game__container container">
      <div class="row">
        ...
        <ul class="game__list d-flex justify-content-center flex-wrap align-items-stretch col-12">
            ...
            <div class="game__image">
              ...
              <div class="game__descr col-12">
                <div class="game__wrapper-name col-12">
                  <a class="game__name-game col-12" href="big-bucks.php">
                    Big bucks bandits
                  </a>
                 </div>
                 <div class="game__wrapper-play col-12">
                   <a class="game__play  col-12" href="big-bucks.php">
                    Bawić się
                   </a>
                 </div>
              </div>
         ...
         <div class="game__descr col-12">
          <div class="game__wrapper-name col-12">
            <a class="game__name-game col-12" href="one-armed-bandit.php">
              One armed bandit
            </a>
           </div>
           <div class="game__wrapper-play col-12">
             <a class="game__play  col-12" href="one-armed-bandit.php">
              Bawić się
             </a>
           </div>
         </div>
          ...
          <div class="game__descr col-12">
            <div class="game__wrapper-name col-12">
              <a class="game__name-game col-12 " href="desperate-dawgs.php">
                Desperate dawgs
              </a>
             </div>
             <div class="game__wrapper-play col-12">
               <a class="game__play  col-12" href="desperate-dawgs.php">
                Bawić się
               </a>
             </div>
          </div>
   ...
   <section class="benefits">
    <div class="benefits__container container">
      <div class="row">
        <h2 class="benefits__title col-12">
          Nasze atuty
        </h2>
        <ul class="benefits__list d-flex justify-content-center align-items-stretch flex-wrap">
          <li class="benefits__item d-flex flex-column">
            ...
            <div class="benefits__descr d-flex flex-column align-items-center justify-content-center">
