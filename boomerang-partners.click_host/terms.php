    ...
    <main>
      <section class="block-terms">
        <div class="container">
          ...
          <p>Welcome to boomerang-partners.click!</p>

          <p>These terms and conditions outline the rules and regulations for the use of boomerang-partners.click's
            Website, located at boomerang-partners.click.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            boomerang-partners.click if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <p>We employ the use of cookies. By accessing boomerang-partners.click, you agreed to use cookies in agreement
            with the boomerang-partners.click's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, boomerang-partners.click and/or its licensors own the intellectual property rights
            for all material on boomerang-partners.click. All intellectual property rights are reserved. You may access
            this from boomerang-partners.click for your own personal use subjected to restrictions set in these terms
            and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from boomerang-partners.click</li>
            <li>Sell, rent or sub-license material from boomerang-partners.click</li>
            <li>Reproduce, duplicate or copy material from boomerang-partners.click</li>
            <li>Redistribute content from boomerang-partners.click</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. boomerang-partners.click does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the views and opinions of
            boomerang-partners.click,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, boomerang-partners.click
          ...
          <p>boomerang-partners.click reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant boomerang-partners.click a non-exclusive license to use, reproduce, edit and authorize
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of boomerang-partners.click; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to boomerang-partners.click. Please include your name, your
          ...
          <p>No use of boomerang-partners.click's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
