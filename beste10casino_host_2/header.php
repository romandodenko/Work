      ...
      <div class="row">
        <div class="hd__body d-flex align-items-center justify-content-between">
          ...
          <?php if(isset($_SESSION['logged_user'])) : ?>
            ...
            <!-- <div class="header__profile profile  d-flex align-items-center flex-column justify-content-center" data-da=".hd__wrapper-menu, 991, 2">
              <p class="profile__text text"><?php echo $_SESSION['logged_user']->email; ?></p>
              <a href="logout.php" class="profile__btn">Exit</a>
          </div>  -->

          <?php else : ?>

            <!-- <div class="hd__buttons d-flex align-items-center flex-column flex-lg-row col4 col-xl-3" data-da=".hd__wrapper-menu, 991, 2">
