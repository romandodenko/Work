        ...
        <div class="row">
          <div class="gm-ab__body d-flex flex-column flex-lg-row">
            <div class="gm-ab__image">
              <picture>
              <source media="(min-width: 601px)" srcset="./img/goldenox-sg.webp" type="image/webp">
              <source media="(max-width: 600px)" srcset="./img/goldenox-sg_320.png" type="image/png">
              <source media="(max-width: 600px)" srcset="./img/goldenox-sg_320.webp" type="image/webp">
              <img src="./img/goldenox-sg.png" alt="Goldenox">
              </picture>
            </div>
            <div class="gm-ab__descr">
              ...
              <p class="gm-ab__text">
                Die Macher des Spielautomaten ließen sich vom Thema des chinesischen Neujahrs inspirieren. Während des Spiels wird der Benutzer von einem interessanten Soundtrack begleitet. Es wird betont, dass die Symbole Fisch, rote Laterne und Feuerwerkskörper sogar aus 2 Symbolen eine Gewinnkombination ergeben.
              </p>
              <div class="gm-ab__wrapper-link">
                <a class="gm-ab__link game-play" href="goldenox-play.php">Spiel</a>
              </div>
            </div>
          </div>
        </div>
