    ...
    <header class="header">
      <div class="header__container container">
        ...
        <div class="header__menu">
          ...
          <li class="nav__item">
            <a class="nav__link" href="main.php#benefits">Vorteile</a>
            </li>
            <li class="nav__item">
              <a class="nav__link" href="main.php#games">Spiele</a>
              </li>
              <li class="nav__item">
                <a class="nav__link" href="main.php#about">Über uns</a>
                </li>
          </ul>
          </nav>
