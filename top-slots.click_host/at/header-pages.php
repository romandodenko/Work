      ...
      <div class="header__bottom">
        <nav class="header__nav">
          <ul class="header__list">
            ...
            <li class="header__item">
              <a class="header__link link" href="index.php#games">Spiele</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index.php#blog">Bloggen</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index.php#benefist">Vorteile</a>
            </li>
          </ul>
        </nav>
