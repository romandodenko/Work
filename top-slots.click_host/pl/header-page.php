      ...
      <div class="header__bottom">
        <nav class="header__nav">
          <ul class="header__list">
            ...
            <li class="header__item">
              <a class="header__link link" href="index-poland.php#games">Gry</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index-poland.php#blog">Blogować</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index-poland.php#benefist">Zalety</a>
            </li>
          </ul>
        </nav>
