  ...
  <main>
    <section class="terms">
      <div class="terms__container container">
        <h1>Cookie Policy for royaleagent.com</h1>

        <p>This is the Cookie Policy for royaleagent.com, accessible from royaleagent.com</p>
        ...
        <ul>
          ...
          <li>
            <p>Several partners advertise on our behalf and affiliate tracking cookies simply allow us to see if our
              customers have come to the site through one of our partner sites so that we can credit them appropriately
              and where applicable allow our affiliate partners to provide any bonus that they may provide you for
              making a purchase.</p>
          </li>
