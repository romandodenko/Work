...
<html lang="en-us">
  ...
  <body style="text-align: center">
    ...
    <script src="Build/wheelExample2.loader.js"></script>
    <script>
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: "Build/wheelExample2.data",
        frameworkUrl: "Build/wheelExample2.framework.js",
        codeUrl: "Build/wheelExample2.wasm",
