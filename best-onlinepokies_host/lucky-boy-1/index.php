...
<html lang="en-us">
  ...
  <body style="text-align: center">
    ...
    <script src="Build/wheelExample1.loader.js"></script>
    <script>
      createUnityInstance(document.querySelector("#unity-canvas"), {
        dataUrl: "Build/wheelExample1.data",
        frameworkUrl: "Build/wheelExample1.framework.js",
        codeUrl: "Build/wheelExample1.wasm",
