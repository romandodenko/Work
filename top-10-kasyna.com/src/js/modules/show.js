...
export function show() {
  ...
  function showCode(showBtn, collapseBtn, listItem, lists) {
    ...
    let items = 10; // элементы которые изначально показаны на странице, у меня в примере 6 , если меняем здесь чисто то и меняем число в items ниже, где вешаем событие на collapse
  ...
  showCode("класс кнопки которая показывает элементы", "класс кнопки которая скрывает элементы", "класс элементов списка", "класс списка")
