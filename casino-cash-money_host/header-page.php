      ...
      <div class="header__top">
        ...
        <nav class="header__nav">
          <ul class="header__list">
            ...
            <li class="header__item">
              <a class="header__link link" href="index.php#games">Games</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index.php#faq">Faq</a>
            </li>
            <li class="header__item">
              <a class="header__link link" href="index.php#advantages">Advantages</a>
            </li>
          </ul>
        </nav>
...
<body>
  <header class="header">
    <div class="header__container container">
      <div class="header__top">
        <div class="header__wrapper-logo">
          <a class="header__logo" href="index.html">Casino cash <span>money</span></a>
        </div>
        <nav class="header__nav">
          <ul class="header__list">
            <li class="header__item">
            ...
            <li class="header__item">
              <a class="header__link link link-anchor" href="index.php#games">Games</a>
            </li>
            <li class="header__item">
              <a class="header__link link link-anchor" href="index.php#faq">Faq</a>
            </li>
            <li class="header__item">
              <a class="header__link link link-anchor" href="index.php#advantages">Advantages</a>
            </li>
            <li class="header__item">
