    ...
    <main>
      <section class="privacy">
        <div class="privacy__container container">
          <h1 data-aos="fade-down">Privacy Policy for Crown social</h1>

          <p data-aos="fade-down">At crown-social.com, accessible from crown-social.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            crown-social.com and how we use it.</p>

          <p data-aos="fade-down">If you have additional questions or require more information about our Privacy Policy, do not hesitate to
            contact us.</p>

          <h2 data-aos="fade-down">Consent</h2>

          <p data-aos="fade-down">By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

          <h2 data-aos="fade-down">Information we collect</h2>

          <p data-aos="fade-down">The personal information that you are asked to provide, and the reasons why you are asked to provide it,
            will be made clear to you at the point we ask you to provide your personal information.</p>
          <p data-aos="fade-down">If you contact us directly, we may receive additional information about you such as your name, email
          ...
          <p data-aos="fade-down">When you register for an Account, we may ask for your contact information, including items such as name,
            company name, address, email address, and telephone number.</p>

          <h2 data-aos="fade-down">How we use your information</h2>

          <p data-aos="fade-down">We use the information we collect in various ways, including to:</p>
          ...
          <h2 data-aos="fade-down">Log Files</h2>

          <p data-aos="fade-down">crown-social.com follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <h2 data-aos="fade-down">Cookies and Web Beacons</h2>

          <p data-aos="fade-down">Like any other website, crown-social.com uses 'cookies'. These cookies are used to store information
          ...
          <h2 data-aos="fade-down">Our Advertising Partners</h2>

          <p data-aos="fade-down">Some of advertisers on our site may use cookies and web beacons. Our advertising partners are listed below.
          ...
          <h2 data-aos="fade-down">Advertising Partners Privacy Policies</h2>

          <p data-aos="fade-down">You may consult this list to find the Privacy Policy for each of the advertising partners of
            crown-social.com.</p>

          <p data-aos="fade-down">Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on crown-social.com, which are sent directly
          ...
          <p data-aos="fade-down">Note that crown-social.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2 data-aos="fade-down">Third Party Privacy Policies</h2>

          <p data-aos="fade-down">crown-social.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
          ...
          <p data-aos="fade-down">You can choose to disable cookies through your individual browser options. To know more detailed
            information about cookie management with specific web browsers, it can be found at the browsers' respective
            websites.</p>

          <h2 data-aos="fade-down">CCPA Privacy Rights (Do Not Sell My Personal Information)</h2>

          <p data-aos="fade-down">Under the CCPA, among other rights, California consumers have the right to:</p>
          <p data-aos="fade-down">Request that a business that collects a consumer's personal data disclose the categories and specific
            pieces of personal data that a business has collected about consumers.</p>
          <p data-aos="fade-down">Request that a business delete any personal data about the consumer that a business has collected.</p>
          <p data-aos="fade-down">Request that a business that sells a consumer's personal data, not sell the consumer's personal data.</p>
          <p data-aos="fade-down">If you make a request, we have one month to respond to you. If you would like to exercise any of these
            rights, please contact us.</p>

          <h2 data-aos="fade-down">GDPR Data Protection Rights</h2>

          <p data-aos="fade-down">We would like to make sure you are fully aware of all of your data protection rights. Every user is
            entitled to the following:</p>
          <p data-aos="fade-down">The right to access – You have the right to request copies of your personal data. We may charge you a small
            fee for this service.</p>
          <p data-aos="fade-down">The right to rectification – You have the right to request that we correct any information you believe is
            inaccurate. You also have the right to request that we complete the information you believe is incomplete.
          </p>
          <p data-aos="fade-down">The right to erasure – You have the right to request that we erase your personal data, under certain
            conditions.</p>
          <p data-aos="fade-down">The right to restrict processing – You have the right to request that we restrict the processing of your
            personal data, under certain conditions.</p>
          <p data-aos="fade-down">The right to object to processing – You have the right to object to our processing of your personal data,
            under certain conditions.</p>
          <p data-aos="fade-down">The right to data portability – You have the right to request that we transfer the data that we have
