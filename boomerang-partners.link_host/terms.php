    ...
    <main>
      <section class="terms">
        <div class="container">
          ...
          <p>Welcome to boomerang-partners.link!</p>

          <p>These terms and conditions outline the rules and regulations for the use of boomerang-partners.link's
            Website, located at boomerang-partners.link.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            boomerang-partners.link if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <p>We employ the use of cookies. By accessing boomerang-partners.link, you agreed to use cookies in agreement
            with the boomerang-partners.link's Privacy Policy. </p>
          ...
          <p>Unless otherwise stated, boomerang-partners.link and/or its licensors own the intellectual property rights
            for all material on boomerang-partners.link. All intellectual property rights are reserved. You may access
            this from boomerang-partners.link for your own personal use subjected to restrictions set in these terms
            and conditions.</p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from boomerang-partners.link</li>
            <li>Sell, rent or sub-license material from boomerang-partners.link</li>
            <li>Reproduce, duplicate or copy material from boomerang-partners.link</li>
            <li>Redistribute content from boomerang-partners.link</li>
          </ul>

          <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. boomerang-partners.link does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the views and opinions of
            boomerang-partners.link,its agents and/or affiliates. Comments reflect the views and opinions of the person
            who post their views and opinions. To the extent permitted by applicable laws, boomerang-partners.link
          ...
          <p>boomerang-partners.link reserves the right to monitor all Comments and to remove any Comments which can be
          ...
          <p>You hereby grant boomerang-partners.link a non-exclusive license to use, reproduce, edit and authorize
          ...
          <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of boomerang-partners.link; and (d) the link is in the context of general resource information.</p>
          ...
          <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to boomerang-partners.link. Please include your name, your
          ...
          <p>No use of boomerang-partners.link's logo or other artwork will be allowed for linking absent a trademark
            license agreement.</p>
