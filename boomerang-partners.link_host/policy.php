...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Privacy Policy for boomerang-partners.link</h1>

          <p>At boomerang-partners.link, accessible from boomerang-partners.link, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by boomerang-partners.link and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in boomerang-partners.link. This policy is not
          ...
          <p>boomerang-partners.link follows a standard procedure of using log files. These files log visitors when
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
            boomerang-partners.link.</p>

          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on boomerang-partners.link, which are sent
          ...
          <p>Note that boomerang-partners.link has no access to or control over these cookies that are used by
            third-party advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>boomerang-partners.link's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>boomerang-partners.link does not knowingly collect any Personal Identifiable Information from children
