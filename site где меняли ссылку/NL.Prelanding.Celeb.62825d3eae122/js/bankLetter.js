...
const updDate = getYesterdayDate().toLocaleDateString('nl', {
  month: 'numeric',
  day: 'numeric',
  year: 'numeric',
})
...
document.querySelector('.bankLetter-start').innerHTML = `Beginning balance on ${periodStartLong}: $56,251,166.57` 
