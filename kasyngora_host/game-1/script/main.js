...
function onimagesLoaded() {
    ...
    const style = new PIXI.TextStyle({
        ...
        fontStyle: 'normal',
        fontWeight: 'bold',
        fill: ['#0000FF', '#0000FF'], // gradient
        stroke: '#E7E7E7',
        strokeThickness: 2,
        dropShadow: true,
        dropShadowColor: '#87CEEB',
        dropShadowBlur: 4,
    ...
    spinText.x = Math.round((top.width - spinText.width - 21) );
    ...
    // Add header text
    const headerText = new PIXI.Text('Zabawna piłka nożna', style);
