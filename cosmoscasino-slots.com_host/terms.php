      ...
      <div class="page__bottom">
        <main>
          ...
          <section class="terms">
            <div class="container">
              <h1>
                <span><img src="./img/circle.svg" alt="Circle"></span>
                <strong>Terms and Conditions</strong>
              </h1>

              <p>Welcome to cosmoscasino-slots.com!</p>

              <p>These terms and conditions outline the rules and regulations for the use of cosmoscasino-slots.com's
                Website, located at cosmoscasino-slots.com.</p>

              <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                cosmoscasino-slots.com if you do not agree to take all of the terms and conditions stated on this page.
              </p>
              ...
              <p>We employ the use of cookies. By accessing cosmoscasino-slots.com, you agreed to use cookies in
                agreement with the cosmoscasino-slots.com's Privacy Policy. </p>
              ...
              <p>Unless otherwise stated, cosmoscasino-slots.com and/or its licensors own the intellectual property
                rights for all material on cosmoscasino-slots.com. All intellectual property rights are reserved. You
                may access this from cosmoscasino-slots.com for your own personal use subjected to restrictions set in
                these terms and conditions.</p>

              <p>You must not:</p>
              <ul>
                <li>Republish material from cosmoscasino-slots.com</li>
                <li>Sell, rent or sub-license material from cosmoscasino-slots.com</li>
                <li>Reproduce, duplicate or copy material from cosmoscasino-slots.com</li>
                <li>Redistribute content from cosmoscasino-slots.com</li>
              </ul>

              <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. cosmoscasino-slots.com does not filter, edit, publish or review Comments
                prior to their presence on the website. Comments do not reflect the views and opinions of
                cosmoscasino-slots.com,its agents and/or affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent permitted by applicable laws,
                cosmoscasino-slots.com shall not be liable for the Comments or for any liability, damages or expenses
                caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
                this website.</p>

              <p>cosmoscasino-slots.com reserves the right to monitor all Comments and to remove any Comments which can
              ...
              <p>You hereby grant cosmoscasino-slots.com a non-exclusive license to use, reproduce, edit and authorize
              ...
              <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                ...
                absence of cosmoscasino-slots.com; and (d) the link is in the context of general resource information.
              </p>
              ...
              <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to cosmoscasino-slots.com. Please include your name,
              ...
              <p>No use of cosmoscasino-slots.com's logo or other artwork will be allowed for linking absent a trademark
                license agreement.</p>
