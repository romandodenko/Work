...
?>
      ...
      <div class="frame">
       <div class="frame__container container">
        <div class="frame__content politicks">
          <h1><strong>Terms and Conditions</strong></h1>

          <p>Welcome to discwithchildrensgames.com!</p>

          <p>These terms and conditions outline the rules and regulations for the use of discwithchildrensgames.com's
            Website, located at discwithchildrensgames.com.</p>

          <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
            discwithchildrensgames.com if you do not agree to take all of the terms and conditions stated on this page.
          </p>
          ...
          <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
            ...
            <p>We employ the use of cookies. By accessing discwithchildrensgames.com, you agreed to use cookies in
              agreement with the discwithchildrensgames.com's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, discwithchildrensgames.com and/or its licensors own the intellectual property
              rights for all material on discwithchildrensgames.com. All intellectual property rights are reserved. You
              may access this from discwithchildrensgames.com for your own personal use subjected to restrictions set in
              these terms and conditions.</p>
  
            <p>You must not:</p>
            <ul>
              <li>Republish material from discwithchildrensgames.com</li>
              <li>Sell, rent or sub-license material from discwithchildrensgames.com</li>
              <li>Reproduce, duplicate or copy material from discwithchildrensgames.com</li>
              <li>Redistribute content from discwithchildrensgames.com</li>
            </ul>
        </div>
       </div>
      </div>
        ...
        <div class="frame__container container">
          <div class="frame__content politicks">
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
              certain areas
              of the website. discwithchildrensgames.com does not filter, edit, publish or review Comments prior to their
              presence
              on the website. Comments do not reflect the views and opinions of discwithchildrensgames.com,its agents
              and/or
              affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
              extent
              permitted by applicable laws, discwithchildrensgames.com shall not be liable for the Comments or for any
              liability,
            ...
            <p>discwithchildrensgames.com reserves the right to monitor all Comments and to remove any Comments which can
              be
            ...
            <p>You hereby grant discwithchildrensgames.com a non-exclusive license to use, reproduce, edit and authorize
              others to
        ...
        <div class="frame__container container">
          <div class="frame__content politicks">
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
              ...
              records with
              us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of
              discwithchildrensgames.com;
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
              website, you
              must inform us by sending an e-mail to discwithchildrensgames.com. Please include your name, your
              organization name,
            ...
            <p>No use of discwithchildrensgames.com's logo or other artwork will be allowed for linking absent a trademark
              license
              agreement.</p>
          </div>
        </div>
       ...
       <div class="frame__container container">
        <div class="frame__content politicks">
          ...
          <p>We reserve the right to request that you remove all links or any particular link to our Website. You
            ...
            conditions
            and it’s linking policy at any time. By continuously linking to our Website, you agree to be bound to and
            follow these
      ...
      <div class="frame">
       <div class="frame__container container">
        <div class="frame__content backer">
          <div class="backer__body">
            <div class="backer__image">
              <img src="./img/backer.png" alt="Backer">
            </div>
            <div class="backer__wrapper-btn">
              <p class="backer__text">
                There is nothing further...
              </p>
              <button class="backer__btn">
                Back to top
              </button>
            </div>
          </div>
