  ...
  <main>
    ...
    <section class="terms">
      <div class="terms__container container">
        <h1>Polityka plików cookie dla diamondsglory.com</h1>

        <p>To jest polityka dotycząca plików cookie dla diamondsglory.com, dostępna na stronie diamondsglory.com</p>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Od czasu do czasu oferujemy ankiety i kwestionariusze dla użytkowników, aby zapewnić interesujące spostrzeżenia,
              pomocne narzędzia lub dokładniejsze zrozumienie naszej bazy użytkowników. Ankiety te mogą wykorzystywać pliki cookie do zapamiętania
              który już wziął udział w ankiecie lub w celu dostarczenia dokładnych wyników po zmianie stron.</p>
          </li>
        ...
        <ul>
          ...
          <li>
            <p>Kilku partnerów reklamuje się w naszym imieniu, a pliki cookie do śledzenia podmiotów stowarzyszonych po prostu pozwalają nam sprawdzić, czy nasze
              klienci odwiedzili witrynę za pośrednictwem jednej z naszych witryn partnerskich, abyśmy mogli odpowiednio ich zasilić
              i w stosownych przypadkach zezwól naszym partnerom stowarzyszonym na udzielanie wszelkich premii, za które mogą ci zapewnić
              dokonywanie zakupu.</p>
          </li>
