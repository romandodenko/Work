...
export function swiper() {
  document.addEventListener("DOMContentLoaded", function () {
    ...
    //   // }
    // });
    const swiperMainBlock = document.querySelector(".main-swiper");
    if(swiperMainBlock) {
    ...
    const swiperPayBlock = document.querySelector(".payment-swiper");
    if (swiperPayBlock) {
      const swiperPay = new Swiper('.payment-swiper', {
        loop: true,
        observer: true,
        observeParents: true,
        watchOverflow: true,
        ...
        navigation: {
          nextEl: '.payment-swiper__next',
          prevEl: '.payment-swiper__prev',
        },
        breakpoints: {
          319: {
            slidesPerView: 3,
