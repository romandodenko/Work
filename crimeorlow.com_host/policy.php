    ...
    <main>
      <section class="terms">
        <div class="terms__container container">
          <h1><strong>Privacy Policy for crimeorlow.com</strong></h1>

          <p>At crimeorlow.com, accessible from crimeorlow.com, one of our main priorities is the privacy of our
            visitors. This Privacy Policy document contains types of information that is collected and recorded by
            crimeorlow.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in crimeorlow.com. This policy is not applicable
          ...
          <p>crimeorlow.com follows a standard procedure of using log files. These files log visitors when they visit
          ...
          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on crimeorlow.com, which are sent directly to
          ...
          <p>Note that crimeorlow.com has no access to or control over these cookies that are used by third-party
            advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>crimeorlow.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
          ...
          <p>crimeorlow.com does not knowingly collect any Personal Identifiable Information from children under the age
