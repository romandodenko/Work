    ...
    <main>
      <section class="politicks">
        <div class="politicks__container container">
          <h1 class="title" data-aos="zoom-out-up"><strong>Terms and Conditions</strong></h1>

          <p class="text" data-aos="zoom-out-up">Welcome to glo-office.com!</p>

          <p class="text" data-aos="zoom-out-up">These terms and conditions outline the rules and regulations for the use of Glo-office's Website, located
            at glo-office.com.</p>

          <p class="text" data-aos="zoom-out-up">By accessing this website we assume you accept these terms and conditions. Do not continue to use
            glo-office.com if you do not agree to take all of the terms and conditions stated on this page.</p>

          <p class="text" data-aos="zoom-out-up">The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
          ...
          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Cookies</strong></h2>

          <p class="text" data-aos="zoom-out-up">We employ the use of cookies. By accessing glo-office.com, you agreed to use cookies in agreement with the
            Glo-office's Privacy Policy. </p>

          <p class="text" data-aos="zoom-out-up">Most interactive websites use cookies to let us retrieve the user’s details for each visit. Cookies are
          ...
          <h2 class="subtitle" data-aos="zoom-out-up"><strong>License</strong></h2>

          <p class="text" data-aos="zoom-out-up">Unless otherwise stated, Glo-office and/or its licensors own the intellectual property rights for all
            material on glo-office.com. All intellectual property rights are reserved. You may access this from
            glo-office.com for your own personal use subjected to restrictions set in these terms and conditions.</p>

          <p class="text" data-aos="zoom-out-up">You must not:</p>
          <ul data-aos="zoom-out-up">
            <li>Republish material from glo-office.com</li>
            <li>Sell, rent or sub-license material from glo-office.com</li>
            <li>Reproduce, duplicate or copy material from glo-office.com</li>
            <li>Redistribute content from glo-office.com</li>
          </ul>

          <p class="text" data-aos="zoom-out-up">Parts of this website offer an opportunity for users to post and exchange opinions and information in
            certain areas of the website. Glo-office does not filter, edit, publish or review Comments prior to their
            presence on the website. Comments do not reflect the views and opinions of Glo-office,its agents and/or
            affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, Glo-office shall not be liable for the Comments or for any liability,
          ...
          <p class="text" data-aos="zoom-out-up">Glo-office reserves the right to monitor all Comments and to remove any Comments which can be considered
            inappropriate, offensive or causes breach of these Terms and Conditions.</p>

          <p class="text" data-aos="zoom-out-up">You warrant and represent that:</p>
          ...
          <p class="text" data-aos="zoom-out-up">You hereby grant Glo-office a non-exclusive license to use, reproduce, edit and authorize others to use,
            reproduce and edit any of your Comments in any and all forms, formats or media.</p>

          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Hyperlinking to our Content</strong></h2>

          <p class="text" data-aos="zoom-out-up">The following organizations may link to our Website without prior written approval:</p>
          ...
          <p class="text" data-aos="zoom-out-up">These organizations may link to our home page, to publications or to other Website information so long as
          ...
          <p class="text" data-aos="zoom-out-up">We may consider and approve other link requests from the following types of organizations:</p>
          ...
          <p class="text" data-aos="zoom-out-up">We will approve link requests from these organizations if we decide that: (a) the link would not make us
            ...
            of Glo-office; and (d) the link is in the context of general resource information.</p>

          <p class="text" data-aos="zoom-out-up">These organizations may link to our home page so long as the link: (a) is not in any way deceptive; (b)
          ...
          <p class="text" data-aos="zoom-out-up">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
            website, you must inform us by sending an e-mail to Glo-office. Please include your name, your organization
          ...
          <p class="text" data-aos="zoom-out-up">Approved organizations may hyperlink to our Website as follows:</p>
          ...
          <p class="text" data-aos="zoom-out-up">No use of Glo-office's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>

          <h2 class="subtitle" data-aos="zoom-out-up"><strong>iFrames</strong></h2>

          <p class="text" data-aos="zoom-out-up">Without prior approval and written permission, you may not create frames around our Webpages that alter in
            any way the visual presentation or appearance of our Website.</p>

          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Content Liability</strong></h2>

          <p class="text" data-aos="zoom-out-up">We shall not be hold responsible for any content that appears on your Website. You agree to protect and
          ...
          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Reservation of Rights</strong></h2>

          <p class="text" data-aos="zoom-out-up">We reserve the right to request that you remove all links or any particular link to our Website. You
          ...
          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Removal of links from our website</strong></h2>

          <p class="text" data-aos="zoom-out-up">If you find any link on our Website that is offensive for any reason, you are free to contact and inform us
            any moment. We will consider requests to remove links but we are not obligated to or so or to respond to you
            directly.</p>

          <p class="text" data-aos="zoom-out-up">We do not ensure that the information on this website is correct, we do not warrant its completeness or
          ...
          <h2 class="subtitle" data-aos="zoom-out-up"><strong>Disclaimer</strong></h2>

          <p class="text" data-aos="zoom-out-up">To the maximum extent permitted by applicable law, we exclude all representations, warranties and
          ...
          <p class="text" data-aos="zoom-out-up">The limitations and prohibitions of liability set in this Section and elsewhere in this disclaimer: (a) are
          ...
          <p class="text" data-aos="zoom-out-up">As long as the website and the information and services on the website are provided free of charge, we will
