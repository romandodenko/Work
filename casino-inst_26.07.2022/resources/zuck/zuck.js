...
var Zuck = (window => {
  ...
  const getImgList = function(strImgs) {
    let list = strImgs.split(",");
    let result = "";
    for (let value of list) {
      result += `
      <li class="popup-story__pay">
      <img src="${value}" alt="">
      </li>`;
    }
    return result;
  ...
  const getText = function(strImgs) {
    let list = strImgs.split(",");
    let result = "";
    for (let value of list) {
      result += `
      <div class="popup-story__wrapper-text">
           <div class="popup-story__text-icon">
             <img src="./img/okay.png" alt="Okay">
           </div>
           <p class="popup-story__text">
           ${value}
           </p>
         </div>
    `}
    ...
    const optionsDefault = {
      ...
      template: {
        ...
        viewerItemBody(index, currentIndex, item) {
          return `<div class="item ${get(item, 'seen') === true ? 'seen' : ''} ${currentIndex === index ? 'active' : ''}"
          data-time="${get(item, 'time')}" data-type="${get(item, 'type')}" data-index="${index}" data-item-id="${get(item, 'id')}">

          ${
              get(item, 'page') === '1' ? ` <div class="popup-story__top">
              <div class="popup-story__image">
              <img loading="auto" class="media" src="${get(item, 'src')}" ${get(item, 'type')} />
              </div>
              <div class="popup-story__rating">
                <span class="popup-story__rating-value">
                  ${get(item, 'stars')}
                </span>
                <div class="popup-story__rating-stars">
                  <span class="popup-story__rating-star">
            ...
            <div class="popup-story__descr">
              <div class="popup-story__spin">
                <strong class="popup-story__strong">
                  ${get(item, 'fstext')}
                </strong>
                <div class="popup-story__descr-bottom">
                  <div class="popup-story__spin-icon">
                    <img src="./img/free-spin.png" alt="Spin">
                  </div>
                  <p class="popup-story__fs">
                    ${get(item, 'fs')}
                  </p>
                </div>
              </div>
              <div class="popup-story__bonus">
                <strong class="popup-story__strong">
                ${get(item, 'pricetext')}
                </strong>
                <div class="popup-story__descr-bottom">
                  <div class="popup-story__bonus-icon">
                    <img src="./img/popup-bonus.png" alt="Bonus">
                  </div>
                  <p class="popup-story__price">
                   ${get(item, 'price')}
                  </p>
                </div>
              </div>
            </div>
            <div class="popup-story__wrapper-link">
              <a class="popup-story__link" href="${get(item, 'link')}">
              ${get(item, 'namelink')}
              </a>
            </div>` : `<div class="popup-story__top">
            <div class="popup-story__image">
            <img loading="auto" class="media" src="${get(item, 'src')}" ${get(item, 'type')} />
            </div>
            <div class="popup-story__rating">
          ...
          <div class="popup-story__descr">
          ${getText(get(item, "benefits"))}
          </div>
          <ul class="popup-story__pays">
          ${getImgList(get(item, "arrimage"))}
          </ul>
          <div class="popup-story__wrapper-link">
            <a class="popup-story__link" href="${get(item, 'link')}">
            ${get(item, 'namelink')}
          ...
          //       ${!get(item, 'linkText') || get(item, 'linkText') === "" ? option("language", 'visitLink') : get(item, 'linkText')}</a>` : ""}
          //   }
          // }
          //       </div>`;
          // return `<div class="item ${get(item, 'seen') === true ? 'seen' : ''} ${currentIndex === index ? 'active' : ''}"
          //           data-time="${get(item, 'time')}" data-type="${get(item, 'type')}" data-index="${index}" data-item-id="${get(item, 'id')}">
          // <div class="popup-story__top">
          //       <div class="popup-story__image">
          //       ${image}
          //       </div>
          //       <div class="popup-story__rating">
          ...
          //     </div>
          //     <div class="popup-story__wrapper-link">
          //       <a class="popup-story__link" href="#!">
          //         Go to casino
          //       </a>
          //     </div>
