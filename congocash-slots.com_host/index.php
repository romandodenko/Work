    ...
    <div class="popup">
      ...
      <div class="popup__body">
        <form class="popup__form" action="/">
          <p class="popup__text">Játékainkat 18 éven felüli FELNŐTT közönségnek szánjuk. A gombra kattintva erősítse meg
            életkorát.</p><label><input type="checkbox" name="number"></label> <label><input type="text"
              name="years-old"></label>
          <div class="popup__form-bottom"><a class="popup__button" href="main.php">Egyetért</a></div>
        </form>
      </div>
    </div>
    <?php 
