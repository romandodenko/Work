  ...
  <main>
    ...
    <section class="pol-cockie">
      <div class="pol-cockie__container container">
        ...
        <p class="text">Welcome to maxslots.fun!</p>

        <p class="text">These terms and conditions outline the rules and regulations for the use of maxslots.fun's Website, located
          at maxslots.fun.</p>

        <p class="text">By accessing this website we assume you accept these terms and conditions. Do not continue to use
          maxslots.fun if you do not agree to take all of the terms and conditions stated on this page.</p>
        ...
        <p class="text">We employ the use of cookies. By accessing maxslots.fun, you agreed to use cookies in agreement with the
          maxslots.fun's Privacy Policy. </p>
        ...
        <p class="text">Unless otherwise stated, maxslots.fun and/or its licensors own the intellectual property rights for all
          material on maxslots.fun. All intellectual property rights are reserved. You may access this from maxslots.fun
          for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p class="text">You must not:</p>
        
        <ul>
          <li>Republish material from maxslots.fun</li>
          <li>Sell, rent or sub-license material from maxslots.fun</li>
          <li>Reproduce, duplicate or copy material from maxslots.fun</li>
          <li>Redistribute content from maxslots.fun</li>
        </ul>
        ...
        <p class="text">Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
          areas of the website. maxslots.fun does not filter, edit, publish or review Comments prior to their presence
          on the website. Comments do not reflect the views and opinions of maxslots.fun,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, maxslots.fun shall not be liable for the Comments or for any liability, damages
        ...
        <p class="text">maxslots.fun reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p class="text">You hereby grant maxslots.fun a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p class="text">We will approve link requests from these organizations if we decide that: (a) the link would not make us look
          ...
          maxslots.fun; and (d) the link is in the context of general resource information.</p>
        ...
        <p class="text">If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
          you must inform us by sending an e-mail to maxslots.fun. Please include your name, your organization name,
        ...
        <p class="text">No use of maxslots.fun's logo or other artwork will be allowed for linking absent a trademark license
          agreement.</p>

        <h2 class="subtitle"><strong>iFrames</strong></h2>

        <p class="text">Without prior approval and written permission, you may not create frames around our Webpages that alter in
