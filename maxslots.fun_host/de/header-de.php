...
<body class="germany">
  <header class="header">
    <div class="header__top">
      ...
      <!-- <a class="header__link-profile link" href="profile-germany.php" data-da=".container-bottom, 1024, 1">Konto</a> -->
        ...
        <nav class="header__nav">
          <ul class="header__list">
            <li class="header__item">
              <a class="header__link link home" href="index-germany.php">
            ...
            <li class="header__item">
              <a class="header__link link" href="all-games-germany.php">
            ...
            <li class="header__item">
              <a class="header__link link" href="blogs-germany.php">
            ...
            <li class="header__item">
              <a class="header__link link" href="about-germany.php">
