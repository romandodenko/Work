  ...
  <header class="header">
    <div class="header__top">
      <div class="header__left">
        <a class="header__logo" href="index-germany.php">Maxslots <span>fun</span></a>
        <a class="header__link-profile link" href="profile-germany.php">Konto</a>
      </div>
      <div class="header__right">
        <a class="header__back" href="index-germany.php">Zurück nach Hause</a>
