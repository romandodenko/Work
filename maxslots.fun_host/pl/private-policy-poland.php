  ...
  <main>
    ...
    <section class="pol-cockie">
      <div class="pol-cockie__container container">
        <h1 class="title">Polityka prywatności dla maxslots.fun</h1>

        <p class="text">W maxslots.fun, dostępnym z maxslots.fun, jednym z naszych głównych priorytetów jest prywatność odwiedzających.
          Niniejszy dokument dotyczący Polityki prywatności zawiera rodzaje informacji gromadzonych i rejestrowanych przez maxslots.fun i
          jak go używamy.</p>

        <p class="text">Jeśli masz dodatkowe pytania lub potrzebujesz więcej informacji na temat naszej Polityki prywatności, nie wahaj się
          skontaktuj się z nami.</p>

        <p class="text">Niniejsza Polityka prywatności dotyczy tylko naszych działań online i jest ważna dla odwiedzających naszą stronę internetową z
          w odniesieniu do informacji, które udostępniają i/lub zbierają w maxslots.fun. Niniejsze zasady nie mają zastosowania do
          wszelkie informacje zebrane w trybie offline lub za pośrednictwem kanałów innych niż ta strona internetowa.</p>

        <h2 class="subtitle">Zgoda</h2>

        <p class="text">Korzystając z naszej witryny, niniejszym wyrażasz zgodę na naszą Politykę prywatności i zgadzasz się na jej warunki.</p>

        <h2 class="subtitle">Informacje, które zbieramy</h2>

        <p class="text">Dane osobowe, o które jesteś proszony, oraz powody, dla których jesteś proszony o ich podanie, będą
          być jasne w momencie, w którym prosimy o podanie swoich danych osobowych.</p>
        <p class="text">Jeśli skontaktujesz się z nami bezpośrednio, możemy otrzymać dodatkowe informacje o Tobie, takie jak imię i nazwisko, adres e-mail,
          numer telefonu, treść wiadomości i/lub załączników, które możesz nam wysłać, oraz wszelkie inne informacje, które
          może zdecydować się na dostarczenie.</p>
        <p class="text">Kiedy zarejestrujesz Konto, możemy poprosić Cię o Twoje dane kontaktowe, w tym takie elementy jak imię i nazwisko,
          nazwa firmy, adres, adres e-mail i numer telefonu.</p>

        <h2 class="subtitle">Jak wykorzystujemy Twoje informacje</h2>

        <p class="text">Informacje, które zbieramy, wykorzystujemy na różne sposoby, w tym do:</p>
        ...
        <h2 class="subtitle">Pliki dziennika</h2>

        <p class="text">maxslots.fun stosuje standardową procedurę korzystania z plików dziennika. Te pliki rejestrują odwiedzających, gdy odwiedzają
        ...
        <h2 class="subtitle">Pliki cookie i sygnalizatory WWW</h2>

        <p class="text">Jak każda inna witryna, maxslots.fun używa plików „cookies”. Te pliki cookie służą do przechowywania informacji, w tym:
        ...
        <h2 class="subtitle">Plik cookie Google DoubleClick DART</h2>

       <p class="text">Google jest jednym z zewnętrznych dostawców w naszej witrynie. Wykorzystuje również pliki cookie, znane jako pliki cookie DART, do wyświetlania reklam
          odwiedzającym naszą witrynę na podstawie ich wizyty na stronie www.website.com i innych witrynach w Internecie.</p>

        <h2 class="subtitle">Nasi partnerzy reklamowi</h2>

        <p class="text">Niektórzy reklamodawcy w naszej witrynie mogą używać plików cookie i sygnałów nawigacyjnych. Lista naszych partnerów reklamowych znajduje się poniżej.
        ...
        <h2 class="subtitle">Polityka prywatności partnerów reklamowych</h2>

        <p class="text">Możesz zapoznać się z tą listą, aby znaleźć Politykę prywatności dla każdego z partnerów reklamowych maxslots.fun.
        </p>

        <p class="text">Serwery reklamowe lub sieci reklamowe innych firm korzystają z technologii takich jak pliki cookie, JavaScript czy sygnalizatory WWW, które są
          wykorzystywane w odpowiednich reklamach i linkach, które pojawiają się na maxslots.fun, które są wysyłane bezpośrednio do
        ...
        <p class="text">Pamiętaj, że maxslots.fun nie ma dostępu ani kontroli nad tymi plikami cookie, które są używane przez strony trzecie
          reklamodawców.</p>

        <h2 class="subtitle">Polityka prywatności stron trzecich</h2>

        Polityka prywatności <p class="text">maxslots.fun nie dotyczy innych reklamodawców ani witryn. Dlatego radzimy, aby
          zapoznaj się z odpowiednimi Politykami prywatności tych zewnętrznych serwerów reklamowych, aby uzyskać bardziej szczegółowe informacje. Może
          zawierać ich praktyki i instrukcje dotyczące rezygnacji z niektórych opcji. </p>

        <p class="text">Możesz wyłączyć pliki cookie za pomocą indywidualnych opcji przeglądarki. Aby poznać bardziej szczegółowe informacje
        ...
        <h2 class="subtitle">Prawa prywatności CCPA (nie sprzedawaj moich danych osobowych)</h2>

        <p class="text">Na mocy ustawy CCPA konsumenci z Kalifornii mają między innymi prawo do:</p>
        <p class="text">Żądanie od firmy, która gromadzi dane osobowe konsumenta, ujawnienia kategorii i określonych elementów
          danych osobowych zebranych przez firmę na temat konsumentów.</p>
        <p class="text">Poproś firmę o usunięcie wszelkich zebranych przez firmę danych osobowych dotyczących konsumenta.</p>
        <p class="text">Poproś, aby firma, która sprzedaje dane osobowe konsumenta, a nie sprzedawała dane osobowe konsumenta.</p>
        <p class="text">Jeśli złożysz prośbę, mamy miesiąc na odpowiedź. Jeśli chcesz skorzystać z któregokolwiek z nich
          praw, skontaktuj się z nami.</p>

       <h2 class="subtitle">Prawa dotyczące ochrony danych RODO</h2>

        <p class="text">Chcielibyśmy upewnić się, że jesteś w pełni świadomy wszystkich swoich praw do ochrony danych. Każdy użytkownik jest uprawniony
          do następujących:</p>
        <p class="text">Prawo dostępu – Masz prawo zażądać kopii swoich danych osobowych. Możemy obciążyć Cię niewielką opłatą
          opłata za tę usługę.</p>
        <p class="text">Prawo do sprostowania — masz prawo zażądać od nas poprawienia wszelkich informacji, które Twoim zdaniem są
          niedokładny. Masz również prawo zażądać od nas uzupełnienia informacji, które Twoim zdaniem są niekompletne.</p>
        <p class="text">Prawo do usunięcia – Masz prawo zażądać, abyśmy usunęli Twoje dane osobowe, pod pewnymi
          warunki.</p>
        <p class="text">Prawo do ograniczenia przetwarzania – Masz prawo zażądać, abyśmy ograniczyli przetwarzanie Twojego
          dane osobowe, pod pewnymi warunkami.</p>
        <p class="text">Prawo do sprzeciwu wobec przetwarzania – Masz prawo sprzeciwić się przetwarzaniu przez nas Twoich danych osobowych,
          pod pewnymi warunkami.</p>
        <p class="text">Prawo do przenoszenia danych – Masz prawo zażądać od nas przeniesienia posiadanych przez nas danych
