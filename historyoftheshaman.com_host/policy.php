...
?>
    <main>
      <section class="terms">
        <div class="container">
          <h1>Privacy Policy for historyoftheshaman.com</h1>

          <p>At historyoftheshaman.com, accessible from historyoftheshaman.com, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that is collected and
            recorded by historyoftheshaman.com and how we use it.</p>
          ...
          <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
            regards to the information that they shared and/or collect in historyoftheshaman.com. This policy is not
          ...
          <p>historyoftheshaman.com follows a standard procedure of using log files. These files log visitors when they
          ...
          <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
            historyoftheshaman.com.</p>

          <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
            used in their respective advertisements and links that appear on historyoftheshaman.com, which are sent
          ...
          <p>Note that historyoftheshaman.com has no access to or control over these cookies that are used by
            third-party advertisers.</p>

          <h2>Third Party Privacy Policies</h2>

          <p>historyoftheshaman.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are
          ...
          <p>historyoftheshaman.com does not knowingly collect any Personal Identifiable Information from children under
