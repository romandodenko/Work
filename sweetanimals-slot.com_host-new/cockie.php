  ...
  <main>
   ...
   <div class="pol__content">
    <div class="pol__container container">
      <h1>Cookie Policy for sweetanimals-slot.com</h1>

      <p>This is the Cookie Policy for sweetanimals-slot.com, accessible from sweetanimals-slot.com</p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>From time to time we offer user surveys and questionnaires to provide you with interesting insights,
            ...
            who has already taken part in a survey or to provide you with accurate results after you change pages.</p>
        </li>
      ...
      <ul>
        ...
        <li>
          <p>As we sell products it's important for us to understand statistics about how many of the visitors to our
