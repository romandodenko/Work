const app = new PIXI.Application({ backgroundColor: 0x30173A });
...
function onimagesLoaded() {
    ...
    spinText.x = Math.round((top.width - spinText.width - 30) );
    ...
    // Add header text
    const headerText = new PIXI.Text('BEAUTIFUL FLOWER!', style);
