          ...
          <div class="game-solo__body">
            <div class="game-solo__top">
              ...
              <div class="game-solo__descr">
                <h3 class="game-solo__subtitle">
                  Faraoni egizi
                </h3>
                <p class="game-solo__text text">
                  L'Egitto ha sempre attratto gli amanti dei tesori. Penetra nella piramide e trova il tesoro!
                </p>
                <div class="game-solo__wrapper-play">
                  <a class="game-solo__play link" href="./game-1/index.html">Giocare</a>
                </div>
              </div>
            </div>
          </div>
